...
<template>
  <div id="app">
    ...
    <!--TodoInput 컴포넌트 넣음. 하위 addTodo내보냄 상위 "addTodo"를 내보냄-->
    <TodoInput v-on:addTodo="addTodo"></TodoInput>
    <!--TodoList 컴포넌트 넣음. 하위 removeTodo 상위 "removeTodo" 내보냄. 그리고 상위 "todoItems"를 하위 컴포넌트인 TodoList propsdata 형식으로 내보냄-->
